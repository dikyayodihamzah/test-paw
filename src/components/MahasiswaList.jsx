...
const Mahasiswa = props => (
    <tr>
        ...
        <td>
            <button className="btn btn-secondary"><Link to={"/update/"+props.mahasiswa._id} style={{color:"white"}}>Edit</Link></button> | <button className="btn btn-danger" onClick={() => {props.deleteMahasiswa(props.mahasiswa._id) }}>Delete</button>
        </td>
    </tr>
)
